import {
  ...
  Phone, Calendar, Award, TrendingUp, RefreshCw
} from "lucide-react";
    ...
    <div className="min-h-full bg-[#F8F9FA]">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-1 space-y-6">
          ...
          <button 
            onClick={() => switchMode('coach')}
            className="w-full flex items-center justify-center gap-2 py-4 bg-white rounded-[20px] shadow-sm border border-gray-50 text-[#FF7D3B] font-medium hover:bg-[#FF7D3B]/5 transition-colors"
          >
            <RefreshCw size={18} />
            切换到教练模式
          </button>
